...
<style>
    /* Center the loader */
#loader, #loaderMessage, #loaderAppointment {
  position: absolute;
  left: 50%;
  z-index: 1;
  width: 150px;
...
#myDiv, #myDivMessage, #myDivAppointment {
  display: none;
  text-align: center;
}
</style>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 appbox-left bounceInLeft animated wow" data-wow-delay=".6s">
                    ...
                    <span class="color-dark-grey text-right">Right Place</span></h2>
                    ...
                    <div class="appointment-box">
                        <div class="row" id="appointmentBlock" style="padding-top:30px;">
                            ...
                            <div class="col-xs-12 col-sm-6 ">
                                <input type="text" id="appName" name="visitor_name" placeholder="Enter name" required class="form-control">
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <input type="email" id="appEmail" name="visitor_email" placeholder="Enter email address" required class="form-control">
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <input type="text" id="appTelephone" name="visitor_contactnumber" placeholder="Enter phone number" required class="form-control">
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="input-group input-append date width-100" id="datePicker">
                                    <span class="input-group-addon add-on hidden"><span class="glyphicon glyphicon-calendar"></span></span>
                                    <input type="text" id="appDate" class="form-control" name="date" placeholder="Select Date" required="required" />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="submit" id="appointmentFormSubmit" class="btn btn-blue-orange"> Make an appointment <i class="fa fa-send"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<section id='about'>
    <div class="about_property">
        <div class="container">
            <h6 class="section-title text-center color-theme-color bounceInDown animated wow" data-wow-delay=".3s">About property</h6>
            <hr class="section-title-hr">
            <hr class="section-red-line">
            <p class="description bounceInLeft animated wow" data-wow-delay=".6s">
                On a vision to be the for runner in providing and developing comfortable housing units to people of different classes, {{config('app.name')}} has developed safe, health enhancement environment and high quality housing at an affordable price, strategicaly located off the Lagos/Abeokuta express way. Accessible from both Alakuko and Ajegunle bus-stop.<br /> {{config('app.name')}} comprises of 2 and 3 bedroom apartments all ensuite and it is approximately 3 minutes drive from the Lagos/Abeokuta express way.
            </p>
            <ul class="row">
...
<section id='features'>
    <div class="services-3">
        <div class="container">
            <h6 class="section-title text-center color-theme-color  bounceInDown animated wow" data-wow-delay=".6s">Features of {{config('app.name')}}</h6>
            <hr class="section-title-hr">
            <hr class="section-red-line">
            <br />
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 single-box bounceInRight animated wow" data-wow-delay=".7s">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            <h4>Shopping Mall</h4>
                            <hr class="service-title-hr">
                            <p>Built in complex shoppping malls, with materials for the home like kitchen accessories, food items and so on.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 single-box bounceInRight animated wow" data-wow-delay=".5s">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            ...
                            <hr class="service-title-hr">
                            <p>Lawns are well taken care of, use of anti-pest and anti-weed controllers are used to maintain qaulity and beauty.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 single-box bounceInRight animated wow" data-wow-delay=".5s">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            <h4>Gymnasium</h4>
                            <hr class="service-title-hr">
                            <p>Gymnasium to keep the heart and body at check, and to help with exercises and any other sporting activity.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 single-box bounceInLeft animated wow" data-wow-delay=".9s">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 single-box bounceInLeft animated wow" data-wow-delay=".9s">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            ...
                            <hr class="service-title-hr">
                            <p>Installation of parks for children to play, with many fucn activities to keep the children happy.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="applicationform" class="no-padding">
    <div class="property-detail-home">
        <div class="row no-gutters">
            <div class="col-lg-6 col-sm-6 col-md-6 join-card text-center bounceInLeft animated wow" id="applicationFormDiv" data-wow-delay=".6s">
                ...
                <div class="col-xs-6">
                    ...
                    <input list="title" id="titleName" name="title" placeholder="Title" required class="form-control">
                    <datalist id="title">
                        <option value="Mr.">
                        <option value="Mrs.">
                        <option value="Miss">
                ...
                <div class="col-xs-6">
                    <input type="text" id="surname" name="visitor_name" placeholder="Surname" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="otherName" name="visitor_name" placeholder="Other Names" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input list="status" id="statusName" name="status" placeholder="Marital Status" required class="form-control">
                    <datalist id="status">
                        <option value="Single">
                ...
                <div class="col-xs-6">
                    <input type="text" id="nationality" name="nationality" placeholder="Nationality" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="telephone" name="telephone" placeholder="Phone Number" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="email" id="email" name="email" placeholder="Email Address" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="postalAddress" name="postalAddress" placeholder="Postal Address" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="residentialAddress" name="residentialAddress" placeholder="Residential Address" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="occupation" name="occupation" placeholder="Occupation" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input list="property" id="propertyName" name="property" placeholder="Property Type" required class="form-control">
                ...
                <div class="col-xs-6">
                    <input list="payment" id="paymentName" name="payment" placeholder="Payment Option" required class="form-control">
                    <datalist id="payment">
                ...
                <div class="col-xs-6">
                    <input type="text" id="nokName" name="nokName" placeholder="Next Of Kin Name" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="nokAddress" name="nokAddress" placeholder="Next Of Kin Address" required class="form-control">
                </div>
                <div class="col-xs-6">
                    <input type="text" id="nokTelephone" name="nokTelephone" placeholder="Next Of Kin Phone Number" required class="form-control">
                </div>
                <button style="background-color: #e44621" class="btn btn-blue-orange" id="applicationFormSubmit">Submit</button>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 bg-orange bounceInRight animated wow" data-wow-delay=".6s">
                <div class="prop-detail-box">
                    ...
                    <p>{{config('app.name')}} comprises of both 2 and 3 bedroom apartments all ensuit. It is approximately 3 minutes drive from the Lagos/ Abeokuta express way. Accessiblee from both Alakuko and Ajegunle busstop.</p>
                </div>
...
<section id="gallery" class="gallery-classic-section padding-bottom-20">
    <div class="gallery-classic">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6 class="section-title text-center bounceInDown animated wow" data-wow-delay=".6s">{{config('app.name')}} Gallery</h6>
                    <hr class="section-title-hr">
                    <hr class="section-red-line">
                    <ul class="nav nav-tabs text-center bounceInUp animated wow" data-wow-delay=".9s" role="tablist">
                        <li role="presentation" class="active"><a href="#gallerybedrooms" aria-controls="gallerybedrooms" role="tab" data-toggle="tab">Buildings</a></li>
                        <li role="presentation"><a href="#gallerylivingrooms" aria-controls="gallerylivingrooms" role="tab" data-toggle="tab">Living Room</a></li>
                        <!--<li role="presentation"><a href="#gallerykitchen" aria-controls="gallerykitchen" role="tab" data-toggle="tab">Kitchen</a></li>-->
                        <li role="presentation"><a href="#gallerybathroom" aria-controls="gallerybathroom" role="tab" data-toggle="tab">Bathroom</a></li>
                        <li role="presentation"><a href="#galleryswimming" aria-controls="galleryswimming" role="tab" data-toggle="tab">Doors / Corridor</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="gallerybedrooms">
                                <div class="row no-gutters gallery-images">
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/1.jpg" class="lightbox-bedrooms bounceInLeft animated wow" data-wow-delay=".2s"><img src="images/gallery/1.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/2.jpg" class="lightbox-bedrooms bounceInLeft animated wow" data-wow-delay=".4s"><img src="images/gallery/2.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/3.jpg" class="lightbox-bedrooms bounceInLeft animated wow" data-wow-delay=".6s"><img src="images/gallery/3.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/4.jpg" class="lightbox-bedrooms bounceInLeft animated wow" data-wow-delay=".8s"><img src="images/gallery/4.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/5.jpg" class="lightbox-bedrooms bounceInRight animated wow" data-wow-delay=".8s"><img src="images/gallery/5.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/6.jpg" class="lightbox-bedrooms bounceInRight animated wow" data-wow-delay=".6s"><img src="images/gallery/6.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/7.jpg" class="lightbox-bedrooms bounceInRight animated wow" data-wow-delay=".4s"><img src="images/gallery/7.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/8.jpg" class="lightbox-bedrooms bounceInRight animated wow" data-wow-delay=".2s"><img src="images/gallery/8.jpg" alt="Image"></a>
                                    </div>
                                </div>
                            </div>
                            <div role="tabpanel" class="tab-pane" id="gallerylivingrooms">
                                <div class="row no-gutters gallery-images">
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/9.jpg" class="lightbox-bedrooms"><img src="images/gallery/9.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/10.jpg" class="lightbox-bedrooms"><img src="images/gallery/10.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/11.jpg" class="lightbox-bedrooms"><img src="images/gallery/11.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/12.jpg" class="lightbox-bedrooms"><img src="images/gallery/12.jpg" alt="Image"></a>
                                    </div>
                                    <!--<div class="col-xs-6 col-sm-3">-->
                            ...
                            <div role="tabpanel" class="tab-pane" id="gallerybathroom">
                                <div class="row no-gutters gallery-images">
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/25.jpg" class="lightbox-bedrooms"><img src="images/gallery/25.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/26.jpg" class="lightbox-bedrooms"><img src="images/gallery/26.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/27.jpg" class="lightbox-bedrooms"><img src="images/gallery/27.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/28.jpg" class="lightbox-bedrooms"><img src="images/gallery/28.jpg" alt="Image"></a>
                                    </div>
                                    <!--<div class="col-xs-6 col-sm-3">-->
                            ...
                            <div role="tabpanel" class="tab-pane" id="galleryswimming">
                                <div class="row no-gutters gallery-images">
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/33.jpg" class="lightbox-bedrooms"><img src="images/gallery/33.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/34.jpg" class="lightbox-bedrooms"><img src="images/gallery/34.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/35.jpg" class="lightbox-bedrooms"><img src="images/gallery/35.jpg" alt="Image"></a>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <a href="images/gallery/36.jpg" class="lightbox-bedrooms"><img src="images/gallery/36.jpg" alt="Image"></a>
                                    </div>
                                    <!--<div class="col-xs-6 col-sm-3">-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 text-center bounceInUp animated wow" data-wow-delay=".8s">
                    <p>Lily Court is a totally new city created by the master planners in the quiet sub-urban area of Akinde road off Lagos / Abeokuta expressway, Ajegunle, under Ifako-Ijaiye Local Government Area, Lagos. The estate development is built at places close to Mall (Shoprite Mall), School (7mins drive to Convenant University) and Airport (20mins drive to Muritala Mohammed Airpot).</p>
                </div>
                <div class="col-lg-2"></div>
            </div>
            <br />
...
<section id="map" class="padding-top-20">
    <div class="nearby-places">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center bounceInUp animated wow" data-wow-delay=".8s" style="border: 1px solid #000;">
                    <div class="mapouter"><div class="gmap_canvas"><iframe width="847" height="470" id="gmap_canvas" src="https://maps.google.com/maps?q=Opposite%20Pinacle%20Grammar%20School%20Akinde%20Road%2C%20Ajegunle%2C%20Alakuko-%20Lagos.&t=k&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div><style>.mapouter{text-align:right;height:470px;width:93%;}.gmap_canvas {overflow:hidden;background:none!important;height:470px;width:93%;}</style></div>
                </div>
            </div>
            <br />
            <br />
        ...
        <div class="row no-padding footer-agent-contact">
            ...
            <div class="col-sm-6 bg-orange bounceInRight animated wow" data-wow-delay=".7s">
                <div class="footer-reachout" id="messageBlock">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <input type="text" id="visitorName" name="visitor_name" placeholder="Enter name" required class="form-control">
                        </div>
                        <div class="col-xs-12">
                            <input type="email" id="visitorEmail" name="visitor_email" placeholder="Enter email" required class="form-control">
                        </div>
                        <div class="col-xs-12">
                            <input type="text" id="visitorTelephone" name="telephone" placeholder="Enter telephone" required class="form-control">
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <textarea id="visitorMessage" name="visitor_message" placeholder="Message" required class="form-control"></textarea>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                            ...
                            <button type="submit" id="messageFormSubmit" class="btn btn-blue-white"> Submit <i class="fa fa-send"></i></button>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#applicationFormSubmit').click(function(event) {
        ...
        var realId = ['titleName', 'surname', 'otherName', 'statusName', 'sex', 'nationality', 'telephone', 'email', 'postalAddress', 'residentialAddress', 'occupation', 'propertyName', 'paymentName', 'nokName', 'nokAddress', 'nokTelephone'];


        var param = [title, surname, otherName, status, sex, nationality, telephone, email, postalAddress, residentialAddress, occupation, property, payment, nokName, nokAddress, nokTelephone];
    ...
    $('#messageFormSubmit').click(function(event) {
        ...
        // Check if form is filled
        var realId = ['visitorName', 'visitorEmail', 'visitorTelephone', 'visitorMessage'];
    ...
    function messageValidateForm(param1) {
        if (param1 == "") {
            $("#Mes").html("<div class='alert alert-danger'>Please fill all neccessary requirements</div>");
    ...
    function appointmentValidateForm(param1) {
        if (param1 == "") {
            $("#App").html("<div class='alert alert-danger'>Please fill all neccessary requirements</div>");
    ...
    function requestError(param1, x) {
        ...
        $("#" + param1).html("<div class='alert alert-danger'>Error in connection. Please try again</div>");
