                                    ...
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                                                ...
                                                <a href="http://www.jirajgardens.ng" target="_blank">
    <img class="center  autowidth " align="center" border="0" src="http://jirajgardens.ng/images/agropark_logo.png" alt="Agropark" title="LilyCourt" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 71px" width="71">
  </a>
                                            ...
                                            <div class="">
                                                ...
                                                <div style="color:#FFFFFF;font-family:'Bitter', Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 30px;">
                                                    <div style="font-size:12px;line-height:14px;font-family:'Bitter',Georgia,Times,'Times New Roman',serif;color:#FFFFFF;text-align:left;">
                                                        <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 28px; line-height: 33px;">LilyCourt</span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            </div>
                                            <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                                                <a href="http://www.jirajgardens.ng">
    <img class="center  autowidth " align="center" border="0" src="http://jirajgardens.ng/images/lily_logo.png" alt="LilyCourt Logo" title="LilyCourt Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 50%;max-width: 600px" width="600">
  </a>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            </div>
                                            <!--[if (!mso)&(!IE)]><!-->
                                        ...
                                        <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div class="">
                                                ...
                                                <div style="color:#134C75;font-family:'Bitter', Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 5px;">
                                                    <div style="font-size:12px;line-height:14px;font-family:Bitter, Georgia, Times, 'Times New Roman', serif;color:#134C75;text-align:left;">
                                                        <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 24px; line-height: 28px;"><strong>Client Application Form</strong></span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            </div>
                                            <div class="">
                                                ...
                                                <div style="color:#7E7E7E;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 5px; padding-bottom: 20px;">
                                                    <div style="font-size:12px;line-height:18px;color:#7E7E7E;font-family:'Open Sans', Helvetica, Arial, sans-serif;text-align:left;">
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Client Title : {{ $title }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Surname:</b> {{ $surname }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Othername:</b> {{ $otherName }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Status:</b> {{ $status }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Sex:</b> {{ $sex }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Nationality:</b> {{ $nationality }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Telephone:</b> {{ $telephone }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Email:</b> {{ $email }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Postal Address:</b> {{ $postalAddress }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Residential Address:</b> {{ $residentialAddress }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Occupation:</b> {{ $occupation }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Property:</b> {{ $property }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Payment:</b> {{ $payment }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Next Of Kin:</b> {{ $nokName }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Next Of Kin Address:</b> {{ $nokAddress }}</p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Next Of Kin Telephone:</b> {{ $nokTelephone }}</p>
                                                        <br>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://example.com" style="height:31pt; v-text-anchor:middle; width:126pt;" arcsize="58%" strokecolor="#49a6e8" fillcolor="#49a6e8"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px;"><![endif]-->
                                               <!--  <a href="http://example.com" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #49a6e8; border-radius: 24px; -webkit-border-radius: 24px; -moz-border-radius: 24px; max-width: 169px; width: 119px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 25px; padding-bottom: 5px; padding-left: 25px; font-family: 'Open Sans', Helvetica, Arial, sans-serif;mso-border-alt: none">
      <span style="font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size:16px;line-height:32px;">
        <span style="font-size: 14px; line-height: 28px;" data-mce-style="font-size: 14px;">GET THE TICKET</span></span>
    </a> -->
