                                            ...
                                            <div class="">
                                                ...
                                                <div style="color:#134C75;font-family:'Bitter', Georgia, Times, 'Times New Roman', serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 5px;">
                                                    <div style="font-size:12px;line-height:14px;font-family:Bitter, Georgia, Times, 'Times New Roman', serif;color:#134C75;text-align:left;">
                                                        <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 24px; line-height: 28px;"><strong>Client Appointment Form</strong></span></p>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
                                            </div>
                                            <div class="">
                                                ...
                                                <div style="color:#7E7E7E;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 5px; padding-bottom: 20px;">
                                                    <div style="font-size:12px;line-height:18px;color:#7E7E7E;font-family:'Open Sans', Helvetica, Arial, sans-serif;text-align:left;">
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Name : {{ $appName }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Email:</b> {{ $appEmail }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Telephone:</b> {{ $appTelephone }} </p>
                                                        <br>
                                                        <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><b>Date:</b> {{ $appDate }}</p>
                                                        <br>
                                                    </div>
                                                </div>
                                                <!--[if mso]></td></tr></table><![endif]-->
