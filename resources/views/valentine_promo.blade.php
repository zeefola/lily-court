                    ...
                    <div class="row align-items-center" style="margin-top: -8rem;">
                        <div class="col-lg-6 col-md-12">
                            <div class="main-banner-content">
                                ...
                                <h1>Win an all expense paid dinner this season in Lily Court valentine promo and lot
                                    more prices</h1>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <div class="footer-info-contact">
                            ...
                            <h3>Email Us</h3>
                            <span><a
                                    href="https://templates.envytheme.com/cdn-cgi/l/email-protection#c6aea3aaaaa986b2b4afa0aaa3b5e8a5a9ab"><span
                                        class="__cf_email__"
                                        data-cfemail="6e1a1c0708020b1d2e09030f0702400d0103">[email&#160;protected]</span></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
